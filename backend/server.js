...
const normalizePort = val => { // renvoie un port valide, qu'il soit fourni sous la forme d'un numéro ou d'une chaîne avec normalizePort 
...
//appeler app qui est une fonction exécutée via le serveur
